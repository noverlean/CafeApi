...
Недавно я переустановил операционную систему и не проверил, как давно обновлял свою origin-ветку в Git. В результате здесь вы можете видеть очень старую версию репозитория проекта — без OpenAPI-деклараций и множества примеров backend-кода.
