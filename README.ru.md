...
Недавно я сбросил настройки своей ОС и проверил, как позже обновить свою ветку origin на git, и здесь вы можете увидеть очень старую версию репозитория проекта без объявлений openapi и множество примеров внутреннего кода.
